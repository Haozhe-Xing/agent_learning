...
![LLM 幻觉类型与防御策略](../svg/chapter_21_security_02_hallucination_types.svg)
...
![传统模型 vs 推理模型](../svg/chapter_21_security_02_reasoning_model.svg)
...
![多层事实性防线（4 层递进）](../svg/chapter_21_security_02_defense_layers.svg)
...
> 📖 **想深入了解幻觉检测与缓解的学术前沿？** 请阅读 [21.6 论文解读：安全与可靠性前沿研究](./06_paper_readings.md)，涵盖 FActScore、SelfCheckGPT、Self-Consistency、CoVe 等核心论文的深度解读。

> **下一节预告**：Agent 不仅要"说得对"，还要"做得安全"——权限控制至关重要。

---

[21.3 权限控制与沙箱隔离](./03_permission_sandbox.md)
