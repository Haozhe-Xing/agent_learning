...
![Agent Runtime 架构](../svg/chapter_21_security_03_runtime_flow.svg)
...
![Agent 权限控制与沙箱隔离架构](../svg/chapter_21_security_03_permission.svg)
...
[21.4 敏感数据保护](./04_data_protection.md)