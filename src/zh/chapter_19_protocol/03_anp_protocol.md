# 19.3 ANP（Agent Network Protocol）协议
...
![ANP 三层协议栈](../svg/chapter_19_protocol_03_anp_arch.svg)
...
![三协议对比](../svg/chapter_19_protocol_03_three_protocols.svg)
...
*下一节：[19.4 Agent 间的消息传递与状态共享](./04_message_passing.md)*
