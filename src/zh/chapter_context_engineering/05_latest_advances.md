...
**方法介绍**：本文将**上下文工程（CE）**确立为独立学科，综合厂商架构（Google ADK、Anthropic、LangChain）、学术工作（ACE 框架、DeepMind 智能委派）、企业调研（Deloitte/KPMG 2026）和作者自建多智能体系统经验，提出五条生产级上下文质量准则——**相关性、充分性、隔离性、经济性、溯源性**，并把上下文框定为 Agent 的"操作系统"。整体学科金字塔见下图：

![上下文工程学科金字塔：提示词工程 → 上下文工程 → 意图工程 → 规范工程](../svg/chapter_context_paper_2603.09619.png)

> 图源：该论文（来源：2026, arXiv:2603.09619）
