...
![多模态 Agent 处理流程](../svg/chapter_25_multimodal_01_pipeline.svg)
...
> ⏰ *注：上表基于 2026 年 7 月各模型公开的能力信息，模型能力更新频繁，请以官方文档为准。*
...
![多模态 Agent 设计模式](../svg/chapter_25_multimodal_02_modality_fusion.svg)
...
| 主流模型 | GPT-4.1、Claude 4、Gemini 3.1 Pro |
...
[25.2 图像理解与生成](./02_image_understanding.md)
