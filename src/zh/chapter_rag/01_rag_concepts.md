...
| 挑战 | 描述 | 应对策略 |
|------|------|---------|
| **检索质量瓶颈** | 如果检索到了无关文档，再好的 LLM 也无法生成正确答案 | 优化嵌入模型、使用混合检索、重排序（详见 6.4 节） |
...
> 📖 **想深入了解 RAG 的学术前沿？** 请阅读 [6.6 论文解读：RAG 前沿进展](./06_paper_readings.md)，涵盖 RAG 原始论文、Self-RAG、CRAG、GraphRAG、Modular RAG 等核心论文的深度解读，以及从 Naive RAG 到 Agentic RAG 的完整演进脉络。
>
