...
> - 👉 [第12章 LangGraph](../chapter_langgraph/README.md) — 深入 Agentic RAG 所用的状态机框架
> - 👉 [第22章 数据分析项目](../chapter_data_agent/README.md)
...
- 6.7 节额外需要：`pip install graphrag lightrag-hku langgraph`
