...
![结构化输出约束策略演进](../svg/chapter_harness_06_constraint_pipeline.svg)
...
![JSON 解析四层防线](../svg/chapter_harness_06_json_defense.svg)
...
![结构化输出三层防御架构](../svg/chapter_harness_06_three_layer.svg)
