...
- [第9章 Skill System](./chapter_skill/README.md)
  ...
  - [9.8 Skills 圣经：Superpowers 工程实践指南](./chapter_skill/08_superpowers_guide.md)
...
- [第11章 自我进化与持续学习](./chapter_self_evolving/README.md)
  - [11.1 Prompt 自动调优](./chapter_self_evolving/01_automatic_prompt_optimization.md)
  - [11.2 Self-Evolution Agent：从会执行到会自我改进](./chapter_self_evolving/02_self_evolution_agent.md)
  - [11.3 Agentic 数据飞轮：让 Agent 自我进化](./chapter_self_evolving/03_data_flywheel.md)
...
- [第12章 LangChain 深入实战](./chapter_langchain/README.md)
  ...
  - [12.6 LangSmith 集成与可观测性](./chapter_langchain/06_langsmith_integration.md)
  - [12.7 LangChain 生态 2026](./chapter_langchain/07_langchain_ecosystem_2026.md)
  - [12.8 LangChain 生产化模式](./chapter_langchain/08_production_patterns.md)
...
- [第18章 Agent 的评估与优化](./chapter_evaluation/README.md)
  ...
  - [18.6 Agent 专项评估框架](./chapter_evaluation/06_agent_evaluation.md)
  - [18.7 A/B 测试与回归测试自动化](./chapter_evaluation/07_ab_testing.md)
  - [18.8 模型路由评估](./chapter_evaluation/08_model_routing.md)
...
- [第19章 安全与可靠性](./chapter_security/README.md)
  ...
  - [19.7 Guardrails 运行时防护](./chapter_security/07_guardrails_runtime.md)
  - [19.8 红队测试方法论](./chapter_security/08_red_teaming.md)
...
- [第20章 部署与生产化](./chapter_deployment/README.md)
  ...
  - [20.6 模型推理服务化](./chapter_deployment/06_model_serving.md)
  - [20.7 Kubernetes 编排与 Serverless GPU](./chapter_deployment/07_k8s_serverless.md)
  - [20.8 长任务队列与成本治理](./chapter_deployment/08_task_queue_cost.md)
...
- [第23章 项目实战：多模态 Agent](./chapter_multimodal/README.md)
  ...
  - [23.5 Computer Use 与 GUI Agent](./chapter_multimodal/05_computer_use_agent.md)
  - [23.6 视频理解与多模态 RAG](./chapter_multimodal/06_video_and_multimodal_rag.md)
