...
| 小节 | 内容 |
|------|------|
| 20.1 如何评估 Agent 的表现？ | 评估维度、三种评估方法 |
| 20.2 基准测试与评估指标 | SWE-bench、GAIA、WebArena、自定义基准 |
| 20.3 Prompt 调优策略 | 系统提示词优化、A/B 测试 |
| 20.4 成本控制与性能优化 | 模型路由、缓存、压缩 |
| 20.5 可观测性 | 日志、追踪、监控 |
...
>
> **后续推荐**：
> - 👉 [第21章 安全与可靠性](../chapter_21_security/README.md) — 安全也是"质量"的一部分
> - 👉 [第22章 部署与生产化](../chapter_22_deployment/README.md) — 评估指标驱动的生产优化

---

*下一节：[20.1 如何评估 Agent 的表现？](./01_evaluation_methods.md)*
