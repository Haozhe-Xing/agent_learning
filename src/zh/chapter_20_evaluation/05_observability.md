...
![可观测性三大支柱](../svg/chapter_20_evaluation_05_observability.svg)
...
![生产级可观测性架构](../svg/chapter_20_evaluation_05_observability_arch.svg)
...
> 💡 **延伸阅读**：关于 Agent 运行时的模型路由评估和 A/B 测试，详见 [20.7 A/B 测试与回归测试自动化](./07_ab_testing.md) 和 [20.8 模型路由评估](./08_model_routing.md)。

> 🎓 **本章总结**：评估和优化是一个持续迭代的过程。先建立评估体系，然后通过 Prompt 调优、成本控制和可观测性来不断改进 Agent。

---

[第21章 安全与可靠性](../chapter_21_security/README.md)
