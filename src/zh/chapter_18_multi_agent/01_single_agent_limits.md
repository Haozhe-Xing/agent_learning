...
![单Agent三大局限vs多Agent解决方案](../svg/chapter_18_multi_agent_01_limits.svg)
...
> 📖 **想深入了解多 Agent 系统的学术前沿？** 请阅读 [18.6 论文解读：多 Agent 系统前沿研究](./06_paper_readings.md)，涵盖 MetaGPT、ChatDev、AutoGen、AgentVerse 等核心论文的深度解读。
...
*下一节：[18.2 多 Agent 通信模式](./02_communication_patterns.md)*
