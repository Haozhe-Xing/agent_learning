# 16.1 Limitations of Single Agents
...
> 💡 **Further reading**: For specialized evaluation methods for multi-Agent systems (Agent-as-Judge, τ-bench, SWE-bench), see [18.6 Agent-Specific Evaluation Framework](../chapter_evaluation/06_agent_evaluation.md).
