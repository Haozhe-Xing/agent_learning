# 19.6 Paper Readings: Frontiers in Security and Reliability
...
![Application-Layer vs. Model-Layer Defense (StruQ/SecAlign)](../svg/chapter_security_06_struq_defense.svg)
...
![Indirect Injection Attacks in Tool-Calling Scenarios (InjecAgent)](../svg/chapter_security_06_injecagent.svg)
...
![FActScore: Atomic Fact Decomposition and Verification](../svg/chapter_security_06_factscore.svg)
...
![SelfCheckGPT: Sampling-Consistency Hallucination Detection](../svg/chapter_security_06_selfcheckgpt.svg)
...
![Traditional Models vs. Reasoning Models (Hallucination Mitigation)](../svg/chapter_security_02_reasoning_model.svg)
...
![Self-Consistency: Majority-Vote Reasoning](../svg/chapter_security_06_selfcheckgpt.svg)
...
![CoVe: Chain-of-Verification Workflow](../svg/chapter_security_06_cove.svg)
...
*Back to: [Chapter 19 Security and Reliability](./README.md)*
...
![AltTrain: Trade-off Overview of Different Safety Alignment Methods](../svg/chapter_security_paper_2604.18946.png)
...
![SafeAgent Architecture: Runtime Controller + Context-Aware Decision Core](../svg/chapter_security_paper_2604.17562.png)
...
![ClawSafety: A Compromised-but-Accepted Scenario (Deliverable Contains Values)](../svg/chapter_security_paper_2604.01438.png)
...
![TTI Multi-Turn Adversarial Prompt Threat Model](../svg/chapter_security_paper_2604.21860.png)
...
![SIREN: Trade-off Overview of Different Guard Methods](../svg/chapter_security_paper_2604.18519.png)
...
![MCP Pitfall Lab: Multi-Vector Attack Surface Threat Model](../svg/chapter_security_paper_2604.21477.png)
...
![PEO Flow: Directly Optimizing Original Token Embeddings, Nearest-Neighbor Projection Preserves the Visible String](../svg/chapter_security_paper_2604.24983.png)
...
![ARGUS: Typical Case of Existing Defenses Failing Under Context-Dependent Attacks](../svg/chapter_security_paper_2605.03378.png)
...
![ClawGuard Overview: Enforcing User Rules at Tool-Call Boundaries + Deterministic Interception](../svg/chapter_security_paper_2604.11790.png)
...
![SCI Inference-Time Safety Alignment: SMF Static Filtering + DAF Dynamic Agent Filtering](../svg/chapter_security_paper_2605.11664.png)
...
![OrchJail: Orchestration-Guided Fuzzing Jailbreaking T2I Agents](../svg/chapter_security_paper_2605.07414.png)
...
![Black-Box Chatbot: fake-completion vs. exemplification Attack Success Rate Comparison](../svg/chapter_security_paper_2605.18133.png)
...
![Evo-Attacker Framework: Dynamic Attack Memory + Deliberate Reasoning + Attack-Flow GRPO](../svg/chapter_security_paper_2605.25389.png)
...
> 🧬 **One-liner**: Thousands of LLM Agents interacted on the Moltbook social platform for a month; multi-round social interaction raised privacy leakage from 19.95% to 45.30%, with leakage being socially contagious (~8x).
...
![Emergent Languages: Score Distribution Across Language-Purpose Categories](../svg/chapter_security_paper_2605.31170.png)
...
![WebMCP Mid-Session Tool Injection (MSTI) Attack Illustration](../svg/chapter_security_paper_2606.06387.png)
...
![GitInject: Config-File Prompt Injection (CLAUDE.md/AGENTS.md Injected into PR Branch)](../svg/chapter_security_paper_2606.09935.png)
...
![Locate-and-Judge: Attention Locates Top-K + Judge Refines, Two Stages](../svg/chapter_security_paper_2606.23416.png)
