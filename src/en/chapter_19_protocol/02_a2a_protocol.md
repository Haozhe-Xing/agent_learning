# 19.2 A2A (Agent-to-Agent) Protocol
...
![A2A Task State Machine](../svg/chapter_19_protocol_02_a2a_state_machine.svg)
...
*Next section: [19.3 ANP (Agent Network Protocol)](./03_anp_protocol.md)*
