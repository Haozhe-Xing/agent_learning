# 19.1 MCP (Model Context Protocol) Deep Dive
...
![MCP Architecture Diagram](../svg/chapter_19_protocol_01_mcp_arch.svg)
...
*Next section: [19.2 A2A (Agent-to-Agent) Protocol](./02_a2a_protocol.md)*
