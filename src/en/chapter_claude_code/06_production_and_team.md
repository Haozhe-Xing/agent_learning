# 16.6 Production Practice: Using Claude Code Effectively in Teams
...
| Opus | ~$16.00 | Complex architecture design |
...
### Chapter 16 Knowledge Review

| Section | Core Content | Key Insight |
|------|---------|---------|
| **16.1 Basics & Architecture** | Six-layer architecture, System Prompt static/dynamic partitioning | Prompt Caching is the core design for cost reduction |
| **16.2 Permission System** | 7 permission modes, 6-stage decision pipeline | bypassPermissions must never be used in production |
| **16.3 Extension Mechanisms** | MCP, Hooks, Skills, Sub-agents | Hooks' PreToolUse is the strongest interception point |
| **16.4 Multi-Agent Collaboration** | Coordinator/Worker pattern, ULTRAPLAN | Task decomposition is key to multi-agent success |
| **16.5 Production Practice** | CLAUDE.md, team collaboration, security, cost | Engineering standards matter more than the tool itself |
...
*Previous: [16.5 Advanced Usage: MCP, Hooks, and Skills](./05_advanced_usage.md)*  
*Return to chapter index: [Chapter 16: Claude Code Deep Dive: From Usage to Source Code](./README.md)*
