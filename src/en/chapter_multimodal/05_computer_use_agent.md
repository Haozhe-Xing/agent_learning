# 23.5 Computer Use and GUI Agents
...
│                         Computer Use Loop                          │
│                                                                    │
│  User instruction: "Open a browser and search today's weather"     │
│       ↓                                                            │
│  1. Take a screenshot                                              │
│       ↓                                                            │
│  2. The vision model understands the screen content                │
│       ↓                                                            │
│  3. Plan the next action (click / type / scroll)                   │
│       ↓                                                            │
│  4. Execute the action (move the mouse, click, type text)          │
│       ↓                                                            │
...
[23.6 Video Understanding and Multimodal RAG](./06_video_and_multimodal_rag.md)
