# 21.2 Hallucination and Factuality Assurance
...
![LLM Hallucination Types and Defense Strategies](../svg/chapter_21_security_02_hallucination_types.svg)
...
![Multi-layer factuality defense (4 layers)](../svg/chapter_21_security_02_defense_layers.svg)
...
> 📖 **Want to dive deeper into the academic frontiers of hallucination detection and mitigation?** Read [21.6 Paper Readings: Frontier Research in Security and Reliability](./06_paper_readings.md), which covers in-depth analysis of core papers including FActScore, SelfCheckGPT, Self-Consistency, and CoVe.
...
[Next section: 21.3 Permission Control and Sandbox Isolation →](./03_permission_sandbox.md)
