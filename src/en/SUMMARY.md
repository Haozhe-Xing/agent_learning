...
- [Chapter 11: Self-Evolving Agents](./chapter_self_evolving/README.md)
  - [11.1 Automatic Prompt Optimization](./chapter_self_evolving/01_automatic_prompt_optimization.md)
  - [11.2 Self-Evolution Agent: From Execution to Self-Improvement](./chapter_self_evolving/02_self_evolution_agent.md)
  - [11.3 Agentic Data Flywheel: Letting Agents Improve Themselves](./chapter_self_evolving/03_data_flywheel.md)
...
- [Chapter 18: Agent Evaluation and Optimization](./chapter_evaluation/README.md)
  ...
  - [18.6 Agent-Specific Evaluation Frameworks](./chapter_evaluation/06_agent_evaluation.md)
  - [18.7 A/B Testing and Regression Test Automation](./chapter_evaluation/07_ab_testing.md)
  - [18.8 Model Routing Evaluation](./chapter_evaluation/08_model_routing.md)
...
- [Chapter 19: Security and Reliability](./chapter_security/README.md)
  ...
  - [19.7 Guardrails Runtime Protection](./chapter_security/07_guardrails_runtime.md)
  - [19.8 Red Teaming Methodology](./chapter_security/08_red_teaming.md)
...
- [Chapter 20: Deployment and Productionization](./chapter_deployment/README.md)
  ...
  - [20.6 Model Inference Serving](./chapter_deployment/06_model_serving.md)
  - [20.7 Kubernetes Orchestration and Serverless GPU](./chapter_deployment/07_k8s_serverless.md)
  - [20.8 Long-Running Task Queues and Cost Governance](./chapter_deployment/08_task_queue_cost.md)
...
- [Chapter 23: Capstone Project: Multimodal Agent](./chapter_multimodal/README.md)
  ...
  - [23.5 Computer Use and GUI Agents](./chapter_multimodal/05_computer_use_agent.md)
  - [23.6 Video Understanding and Multimodal RAG](./chapter_multimodal/06_video_and_multimodal_rag.md)
